                ...
                <div id="invoice-footer">
                  <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12 text-xs-center">
                      <button type="submit" name="invoice_submit" class="btn btn-primary pull-right my-1" style="margin-right: 5px;"><i class="fa fa fa-check-square-o"></i> Submit Invoice</button>
                    </div>
                  </div>
                </div>
              </div>
