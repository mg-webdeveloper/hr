  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> Edit Invoice #<?php echo $invoice_number;?> </h3>
      </div>
            ...
            <div class="bg-white">
              <div class="box-block">
                ...
                <div class="row no-print">
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary pull-right print-invoice" name="invoice_submit" style="margin-right: 5px;"> <i class="fa fa-download"></i> <i class="fa fa fa-check-square-o"></i> Submit Invoice </button>
                  </div>
                </div>
              </div>
            </div>
