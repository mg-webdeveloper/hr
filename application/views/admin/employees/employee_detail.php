                          ...
                          <?php if($user_info[0]->user_role_id==1){ ?>
                            ...
                            <div class="col-md-4">
                              <div class="form-group" id="department_ajax">
                                ...
                                <select class="form-control" name="department_id" id="aj_subdepartments" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_department');?>">
                                  <option value=""></option>
          ...
          <div class="card-body">
            <div class="card overflow-hidden">
			  ...
			  ?>
                    ...
                    <div class="tab-pane <?php echo $get_animate;?> salary-current-tab" id="commissions">
                      <div class="box-header with-border">
