    ...
    public function designation_list()
     {
		...
		$data = array();
          ...
          foreach($designation->result() as $r) {
			...
			$combhr = $edit.$delete;
			$idesignation_name = $r->designation_name.'<br><small class="text-muted"><i>'.$this->lang->line('xin_department').': '.$department_name.'<i></i></i></small><br><small class="text-muted"><i>'.$this->lang->line('xin_hr_sub_department').': '.$subdep_name.'<i></i></i></small>';
